...
from users.serializers import UserCreateSerializer, UserAutoSerializer, ConfirmUserSerializer
...
class ConfirmUserAPIView(APIView):
    def post_confirm_user(self, request):
...
class AuthorizationAPIView(APIView):
    def post_user_auto(self, request):
        serializer = UserAutoSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
