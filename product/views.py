...
class ProductsListAPIView(ListCreateAPIView):
    ...
    def post_product_validate(self, request, *args, **kwargs):
...
class ProductDetailAPIView(RetrieveUpdateDestroyAPIView):
    ...
    def put_product(self, request, pk, *args, **kwargs):
...
class ReviewListAPIView(ListCreateAPIView):
    ...
    def post_review_validate(self, request, *args, **kwargs):
...
class ReviewDetailAPIView(RetrieveUpdateDestroyAPIView):
    ...
    def put_review(self, request, pk, *args, **kwargs):
...
class CategoryListAPIView(APIView):
    ...
    def post_name(self, request, *args, **kwargs):
...
class CategoryDetailAPIView(RetrieveUpdateDestroyAPIView):
    ...
    def put_name(self, request, pk, *args, **kwargs):
